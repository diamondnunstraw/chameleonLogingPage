...
import yahooMailIcon from '../assets/yahoo-favicon.ico'
  ...
  return (
    <div className='AllBody'>
      <div className="container">
        ...
        <div className="eachCase" onClick={()=> navigate("/yahoo")}>
          <img src={yahooMailIcon} alt="" className="eachImg" />
          <div className="eachTitle">Login With Yahoo</div>
        </div>
      </div>
    </div>
  )
